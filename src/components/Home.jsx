    ...
    return (
        <div className='my-container flex flex-col items-center justify-between lg:flex-row'>
            ...
            <div className='mb-10 lg:max-w-lg lg:pr-5 lg:mb-0'>
                <div className='mx-w-xl mb-6 lg:mt-0'>
                    <div>
                    ...
                    <p className='text-base text-gray-700 md:text-lg'>
                        ...
                        those original thoughts of his aren't very new afte all. The man who
                ...
                <div className='flex flex-col items-center md:flex-row'>
                    ...
                    <Link to='/about' className='inline-flex items-center font-semibold text-gray-800 transition-colors duration-200 hover:text-blue-700'>
                        Learn More
                    </Link>
                </div>
            </div>
